<?php
/**
 * File for class MicrobiltStructBankAccount_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for MicrobiltStructBankAccount_Type originally named BankAccount_Type
 ...
 * @date 2015-11-26
 */
class MicrobiltStructBankAccount_Type extends MicrobiltStructAggregate
{
    /**
     * The OrgInfo
     * Meta informations extracted from the WSDL
     ...
     * - maxOccurs : 1
     * - minOccurs : 0
     * @var MicrobiltStructBankStatement_Type
     */
     ...
     * @return MicrobiltStructBankAccount_Type
     */
     ...
     * @return MicrobiltStructBankStatement_Type|null
     */
     ...
     * @param MicrobiltStructBankStatement_Type $_bankStatement the BankStatement
