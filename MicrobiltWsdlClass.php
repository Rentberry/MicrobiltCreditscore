 ...
 * @date 2015-11-26
 */
class MicrobiltWsdlClass extends stdClass implements ArrayAccess,Iterator,Countable
{
    /**
    ...
    public static function magick_set_state(array $_array,$_className = __CLASS__)
    {
        if(class_exists($_className))
        {
            ...
            if(is_object($object) && is_subclass_of($object,'MicrobiltWsdlClass'))
            {
     ...
     * @uses MicrobiltClassMap::classMap()
     * @uses MicrobiltWsdlClass::getDefaultWsdlOptions()
     * @uses MicrobiltWsdlClass::getSoapClientClassName()
     * @uses MicrobiltWsdlClass::setSoapClient()
     * @param array $_wsdlOptions WSDL options
     * @return void
     */
    public function initSoapClient($_wsdlOptions)
    {
        if(class_exists('MicrobiltClassMap',true))
        {
            $wsdlOptions = array();
            $wsdlOptions['classmap'] = MicrobiltClassMap::classMap();
     ...
     * If a class is named as {Microbilt}SoapClient, then this is the class that will be used.
    ...
    {
        if(class_exists('MicrobiltSoapClient') && is_subclass_of('MicrobiltSoapClient','SoapClient'))
            return 'MicrobiltSoapClient';
        else
            return 'SoapClient';
    }
    /**
     * Method returning all default options values
     * @uses MicrobiltWsdlClass::WSDL_CACHE_WSDL
     * @uses MicrobiltWsdlClass::WSDL_COMPRESSION
     * @uses MicrobiltWsdlClass::WSDL_CONNECTION_TIMEOUT
     * @uses MicrobiltWsdlClass::WSDL_ENCODING
     * @uses MicrobiltWsdlClass::WSDL_EXCEPTIONS
     * @uses MicrobiltWsdlClass::WSDL_FEATURES
     * @uses MicrobiltWsdlClass::WSDL_LOGIN
     * @uses MicrobiltWsdlClass::WSDL_PASSWORD
     * @uses MicrobiltWsdlClass::WSDL_SOAP_VERSION
     * @uses MicrobiltWsdlClass::WSDL_STREAM_CONTEXT
     * @uses MicrobiltWsdlClass::WSDL_TRACE
     * @uses MicrobiltWsdlClass::WSDL_TYPEMAP
     * @uses MicrobiltWsdlClass::WSDL_URL
     * @uses MicrobiltWsdlClass::VALUE_WSDL_URL
     * @uses MicrobiltWsdlClass::WSDL_USER_AGENT
     * @uses MicrobiltWsdlClass::WSDL_PROXY_HOST
     * @uses MicrobiltWsdlClass::WSDL_PROXY_PORT
     * @uses MicrobiltWsdlClass::WSDL_PROXY_LOGIN
     * @uses MicrobiltWsdlClass::WSDL_PROXY_PASSWORD
     * @uses MicrobiltWsdlClass::WSDL_LOCAL_CERT
     * @uses MicrobiltWsdlClass::WSDL_PASSPHRASE
     * @uses MicrobiltWsdlClass::WSDL_AUTHENTICATION
     * @uses MicrobiltWsdlClass::WSDL_SSL_METHOD
     ...
     * @uses MicrobiltWsdlClass::getSoapClient()
     * @uses MicrobiltWsdlClass::getFormatedXml()
     ...
     * @uses MicrobiltWsdlClass::getSoapClient()
     * @uses MicrobiltWsdlClass::convertStringHeadersToArray()
     ...
     * @uses MicrobiltWsdlClass::getInternArrayToIterate()
     ...
     * @see MicrobiltWsdlClass::offsetGet()
     * @uses MicrobiltWsdlClass::offsetGet()
     * @param int $_index
     * @return mixed
     */
     ...
     * @uses MicrobiltWsdlClass::getAttributeName()
     * @uses MicrobiltWsdlClass::__toString()
     * @uses MicrobiltWsdlClass::_set()
     * @uses MicrobiltWsdlClass::_get()
     * @uses MicrobiltWsdlClass::setInternArrayToIterate()
     * @uses MicrobiltWsdlClass::setInternArrayToIterateIsArray()
     * @uses MicrobiltWsdlClass::setInternArrayToIterateOffset()
     ...
     * @uses MicrobiltWsdlClass::item()
     * @uses MicrobiltWsdlClass::length()
     * @return mixed
     */
