<?php
/**
 * File for class MicrobiltStructCollateralInfo_Type
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for MicrobiltStructCollateralInfo_Type originally named CollateralInfo_Type
 ...
 * @date 2015-11-26
 */
class MicrobiltStructCollateralInfo_Type extends MicrobiltStructAggregate
{
    /**
     * The CollateralDesc
     * Meta informations extracted from the WSDL
     ...
     * @param MicrobiltStructPostAddr_Type $_propertyAddress the PropertyAddress
