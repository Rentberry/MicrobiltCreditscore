 ...
 */
/**
 * This class stands for MicrobiltStructMsgRqHdr_Type originally named MsgRqHdr_Type
 ...
 * @date 2015-11-26
 */
class MicrobiltStructMsgRqHdr_Type extends MicrobiltWsdlClass
{
    /**
     * The MemberId
     * Meta informations extracted from the WSDL
     ...
     * @param MicrobiltEnumRequestType $_requestType
     ...
     * @return MicrobiltEnumRequestType|null
     */
     ...
     * @uses MicrobiltEnumRequestType::valueIsValid()
     * @param MicrobiltEnumRequestType $_requestType the RequestType
     * @return MicrobiltEnumRequestType
     */
    public function setRequestType($_requestType)
    {
        if(!MicrobiltEnumRequestType::valueIsValid($_requestType))
        {
            return false;
        }
