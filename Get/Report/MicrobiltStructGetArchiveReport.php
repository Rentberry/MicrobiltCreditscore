<?php
/**
 * File for class MicrobiltStructGetArchiveReport
 * @package Microbilt
 * @subpackage Structs
 ...
 */
/**
 * This class stands for MicrobiltStructGetArchiveReport originally named GetArchiveReport
 ...
 * @date 2015-11-26
 */
class MicrobiltStructGetArchiveReport extends MicrobiltWsdlClass
{
    /**
     * The guid
     * Meta informations extracted from the WSDL
     ...
     * @param string $_guid
     * @return MicrobiltStructGetArchiveReport
     */
